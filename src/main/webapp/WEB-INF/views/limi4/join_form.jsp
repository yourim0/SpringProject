            ...
            <form id="join_form" method="post">
                ...
                <div class="table_css">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input id="id" name="id" placeholder="아이디를 입력하세요."
                                        type="text" class="id">
                                    <button type="button" class="id_double_button input_text">중복확인</button>
                  ...
                  <button type="button" class="join_button"
                     onclick="join_check()" style="width: 290px;">가입하기</button>
...
/*    function num_submit(){
    ...
    $("#phonenum").val(phonenum); //hidden value set
      } */
