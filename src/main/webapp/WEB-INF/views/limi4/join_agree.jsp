               ...
               <div class="proc_agree">
                  <form id="join_agree" method="post">
                     <fieldset>
                        ...
                        <div class="agree">
                           <h3 style="background: none; padding-left: 0">
                              <input type="checkbox" name="all_check" id="all_check"
                                 ...
                                 class="input_checkbox"><label for="all_check"style=" margin-top: 45px;font-size: 19px;">
                                 s.f 사내
                        ...
                        <a class="true"><button type="button" class="agree_button"
                     onclick="check_checked()">동의</button></a>
