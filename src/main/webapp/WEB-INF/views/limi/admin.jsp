									...
									<div class="section1">
										...
										<form id="admin_loginForm" method="post">
											<fieldset>
												<div class="inbox">
													<p class="input_id">
														<label for="user_id"></label><input id="id" name="id"
															placeholder="아이디" autofocus="autofocus" type="text"
															value="" maxlength="30" class="input_text">
													</p>
													<p class="input_pw">
														<label for="user_password"></label><input id="pw"
															name="pw" placeholder="비밀번호" type="password" value=""
															maxlength="30" class="input_password">
													</p>
													<p class="submit">
														<!-- <button type="submit" onclick="login();" class="login_button">로그인</button> -->
														<input type="button" onclick="login_click();"
															class="login_button" value="로그인">
													</p>
												</div>
											</fieldset>
										</form>
