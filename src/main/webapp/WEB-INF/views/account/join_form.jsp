						...
						<table class="fit no_thead">
							...
							<tbody>
								...
								<tr>
									...
									</select> <input id="tel_2" maxlength="4" name="tel_2"
										class="number input_text" title="휴대전화번호 중간자리 3~4자리 입력"
										type="text" value="" size="4" maxlength="4"> <input
										id="tel_3" name="tel_3" maxlength="4"
